...
# ----------------------------------------------------------------------
# 1. Konfigurasi parameter LAI (harus sama di client‐JS nanti)
# ----------------------------------------------------------------------
p = 10007
a = 5
P0 = (1, 0)
...
# ----------------------------------------------------------------------
# 2. Fungsi pembantu: hitung ukuran blok (bytes) maksimum
# ----------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    js_path = os.path.join(repo_root, "script.js")
    output_json = os.path.join(repo_root, "script.json")
